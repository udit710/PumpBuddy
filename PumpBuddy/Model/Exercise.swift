...
//
//enum exerciseType{
//    case cardio, strength, olympic_weightlifting, plyometrics, powerlifting, stretching, strongman
//}
//
//enum muscle: String {
//    case abdominals
...
//    case hamstrings
//    case lats
//    case lowerBack = "lower_back" // Use raw value for names with underscores
//    case middleBack = "middle_back" // Use raw value for names with underscores
//    case neck
//    case quadriceps
//    case traps
//    case triceps
...
//    
//    
//    init(ID: UUID = UUID(), name: String, description: String? = nil, imageName: String? = nil, type: String, muscles: [muscle], isFavourite: Bool? = false) {
//        self.ID = ID
//        self.name = name
...
//let cardioExercise = Exercise(ID: UUID(), name: "Running", description: "Cardio exercise that involves running", imageName: "running.jpg", type: .cardio, muscles: [.calves,.quadriceps,.hamstrings] )
//
////let bodyweightMuscleGroup1 = MuscleGroup(name: .chest, exercises: [])
////let bodyweightMuscleGroup2 = MuscleGroup(name: .triceps, exercises: [])
//let bodyweightExercise = Exercise(ID: UUID(), name: "Push-ups", description: "Bodyweight exercise targeting chest and triceps", imageName: "pushups.jpg", type: .strength, muscles: [.chest,.triceps])
////
////
...
//var exerciseSampleData: [Exercise] = [cardioExercise, bodyweightExercise]
//
//
////Define workout instances for sample data
//var workoutSampleData = [
//    Workout(name: "Morning Run", date: Date(), duration: 30, exercise: [cardioExercise], description: "A morning run to start the day"),
//    Workout(name: "Push-up Session", date: Date(), duration: 45, exercise: [bodyweightExercise], description: "Bodyweight workout focusing on chest and triceps"),
